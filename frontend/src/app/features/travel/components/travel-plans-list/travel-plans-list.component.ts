...
private loadTravelPlans(): void {
  ...
  // COMMENTED OUT online service calls
  /*
  ...
  serviceCall
    ...
    .subscribe({
      ...
      error: (error) => {
        ...
        this.error = 'Unable to connect to the server. Using sample data for demonstration.';
        this.loadSampleData();
        this.loading = false;
        this.snackBar.open('Using sample data - Backend not available', 'Close', { 
          duration: 5000,
  ...
  */
  ...
  onCreateNewPlan(): void {
    ...
    this.snackBar.open('Creating new travel plan...', 'Close', { duration: 2000 });
  }
